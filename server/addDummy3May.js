...
for (const slot of SLOTS) {
  ...
  const postedAt = new Date(2026, 4, 3, sh, sm, rand(0,59));
  newRows.push({
    "Date"        : dateStr,
...
console.log("Dummy data for May 3rd, 2026 has been added and Excel sorted (descending by Time Slot).");
